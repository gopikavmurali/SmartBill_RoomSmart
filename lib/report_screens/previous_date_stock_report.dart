...
class PreviousDateReport extends StatefulWidget {
  const PreviousDateReport({Key? key}) : super(key: key);

  @override
  _PreviousDateReportState createState() => _PreviousDateReportState();
}

class _PreviousDateReportState extends State<PreviousDateReport> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("Previous Date Stock Report",style:MainHeadingStyle()),
      ),
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            ListTile(
              leading: Text("Select Item",style: shortheadstyle(),),
              trailing:  Container(
                height: 40,
                width: 199,
                decoration: BoxDecoration(
            ...
            Column(
              children: [
                Text("Previos Date  Stock Report",style: shortheadstyle(),)
              ],
            )
          ],
        ),
