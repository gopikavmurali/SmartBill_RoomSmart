...
class DateWiseComboReport extends StatefulWidget {
  const DateWiseComboReport({Key? key}) : super(key: key);

  @override
  _DateWiseComboReportState createState() => _DateWiseComboReportState();
}

class _DateWiseComboReportState extends State<DateWiseComboReport> {
  ...
  [
    "Combo Name","Combo Name 1","Combo Name 2","Combo Name 3","Combo Name 4","Combo Name 5","Combo Name 6",
    "Combo Name 7","Combo Name 8",
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("Date Wise Combo Sales report",style:MainHeadingStyle()),
      ),
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            ListTile(
              leading: Text("Combo Name",style: shortheadstyle(),),
              trailing:  Container(
                height: 45,
                width: 199,
          ...
          const SizedBox(height: 10,),
            ...
            Column(
              children: [
                Text("Date Wise Combo Sales Report",style: shortheadstyle(),)
              ],
            )
          ],
        ),
