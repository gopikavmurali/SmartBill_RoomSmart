...
class ItemWiseCancelReport extends StatefulWidget {
  const ItemWiseCancelReport({Key? key}) : super(key: key);

  @override
  _ItemWiseCancelReportState createState() => _ItemWiseCancelReportState();
}

class _ItemWiseCancelReportState extends State<ItemWiseCancelReport> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("Item Wise Cancel Report",style:MainHeadingStyle()),
      ),
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            //       child: Text("Item name",style: sumtextstyle(),),
            //     ),
            //     Padding(
            //       padding: const EdgeInsets.only(left: 12.0,right: 10,top: 10,bottom: 10),
            //       child: Container(
              ...
              trailing: Container(
                ...
                child: TextField(
                  ...
                  onTap: () async {
                    ...
                    startDate.text = date.toString().substring(0,10);
                  },
                ),
              ),
            ),
                  ...
                  child: TextField(
                    ...
                    onTap: () async {
                      var date =  await showDatePicker(
                          ...
                          firstDate:DateTime(1900),
                          lastDate: DateTime(2100));
                      endDate.text = date.toString().substring(0,10);
                    },
                  ),
                ),
              ),
            ...
            Column(
              children: [
                Text("Item Wise Cancel Report",style: shortheadstyle(),)
              ],
            )
          ],
        ),
